 ...
 * @example
    <example name="input-directive" module="inputExample">
      <file name="index.html">
       ...
       <div ng-controller="ExampleController">
         <form name="myForm">
           User name: <input type="text" name="displayName" ng-model="user.name" required>
         ...
         <hr>
         <tt>user = {{user}}</tt><br/>
         <tt>myForm.displayName.$valid = {{myForm.displayName.$valid}}</tt><br>
         <tt>myForm.displayName.$error = {{myForm.displayName.$error}}</tt><br>
      ...
      <file name="protractor.js" type="protractor">
        ...
        var userNameValid = element(by.binding('myForm.displayName.$valid'));
      ...
      angular.module('optionsExample', [])
        .controller('ExampleController', ['$scope', function($scope) {
          ...
          $scope.cancel = function(e) {
            if (e.keyCode == 27) {
              $scope.userForm.displayName.$rollbackViewValue();
            }
          };
        }]);
    </file>
    ...
    <file name="index.html">
      <div ng-controller="ExampleController">
        <form name="userForm">
          ...
          <button ng-click="userForm.displayName.$rollbackViewValue(); user.name=''">Clear</button><br />
        </form>
        <pre>user.name = <span ng-bind="user.name"></span></pre>
      </div>
    </file>
